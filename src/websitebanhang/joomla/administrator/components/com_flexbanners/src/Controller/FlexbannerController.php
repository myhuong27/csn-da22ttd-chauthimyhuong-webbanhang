...
class FlexbannerController extends FormController
{
	/**
	...
	public function batch($model = null)
	{
		...
		// Set the model
		$model = $this->getModel('Flexbanner', '', array());

		// Preset the redirect
		$this->setRedirect(Route::_('index.php?option=com_flexbanners&view=flexbanners' . $this->getRedirectToListAppend(), false));

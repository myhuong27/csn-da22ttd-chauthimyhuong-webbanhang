 ...
 */
namespace Inch\Component\Flexbanners\Administrator\View\Clients;
...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar(): void
	{
		...
		ToolbarHelper::title(Text::_('COM_FLEXBANNERS_MANAGER_CLIENTS'), 'bookmark flexbanners-client');
		...
		$toolbar->help('JHELP_COMPONENTS_FLEXBANNER_CLIENTS');

	}
	protected function getSortFields(): array
	{
		return [
			'a.name' => Text::_('ADMIN_FLEXBANNER_CLIENT'),
			'a.state' => Text::_('JSTATUS'),
			'a.contactname' => Text::_('ADMIN_FLEXBANNER_CONTACTNAME'),
			'a.contactemail' => Text::_('ADMIN_FLEXBANNER_CONTACTEMAIL'),

 ...
 */
namespace Inch\Component\Flexbanners\Administrator\View\Locations;
...
use Inch\Component\Flexbanners\Administrator\Model\LocationsModel;
...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar(): void
	{
		...
		ToolBarHelper::title(Text::_('ADMIN_FLEXBANNER_BANNERMANAGER'), 'bookmark flexbanners-locations');
		...
		$toolbar->help('Flexbanners:_Locations');
	}
